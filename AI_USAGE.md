...
- **Claude 3.7 / Gemini in Cursor & OMP harness**: Used as an interactive technical pair programmer for architecture planning, schema drafting, and test generation.
- **Parallel Deep Research / Context Search**: Used during the initial phase to query current documentation regarding Next.js 16 App Router patterns and Prisma 7 PostgreSQL driver adapter conventions.
